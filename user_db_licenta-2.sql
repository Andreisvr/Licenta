...
INSERT INTO `Applies` (`id`, `title`, `id_thesis`, `id_prof`, `prof_name`, `id_stud`, `stud_name`, `faculty`, `student_program`, `stud_email`, `prof_email`, `applied_data`, `study_year`, `cover_letter`) VALUES
(372, 'dfl;sd', 158, 34, 'Andrei Sviridov', 49, 'Andrei Sviridov', 'Facultatea de Matematică și Informatică', 'Informatica (forma de învățământ la distanță)', 'andrei.sviridov00@e-uvt.ro', 'andreisv178@gmail.com', '2025-03-22', 3, 'SELECT * FROM `studentii` WHERE 1SELECT * FROM `studentii` WHERE 1'),
(373, ';dslfsdl', 159, 34, 'Andrei Sviridov', 49, 'Andrei Sviridov', 'Facultatea de Matematică și Informatică', 'Informatica (forma de învățământ la distanță)', 'andrei.sviridov00@e-uvt.ro', 'andreisv178@gmail.com', '2025-03-22', 3, 'SELECT * FROM `studentii` WHERE 1SELECT * FROM `studentii` WHERE 1');
...
INSERT INTO `favorite` (`favorite_id`, `id_thesis`, `id_user`) VALUES
(153, 157, 49);
...
INSERT INTO `messages` (`id`, `id_stud`, `id_prof`, `mesaje`, `created_at`, `sender`) VALUES
(94, 49, 34, 'mdksikdsk', '2025-03-22 15:12:21', 'prof'),
(95, 49, 34, 'ds,lmd', '2025-03-22 15:14:17', 'stud'),
(96, 49, 34, 'Mesaj Text ', '2025-04-04 15:01:09', 'stud');
...
--
-- Dumping data for table `messages_selection`
--

INSERT INTO `messages_selection` (`id`, `stud_id`, `prof_id`, `message`, `sender`, `location`, `date`) VALUES
(1, 49, 34, 'ssd', 'stud', 'Propose', '2025-03-22 16:09:32'),
(2, 49, 34, 'ffd', 'stud', 'Propose', '2025-03-22 16:09:56'),
(3, 49, 34, 'dsd', 'stud', 'Propose', '2025-03-22 16:30:26'),
(4, 49, 34, 'dslds,', 'stud', 'Propose', '2025-03-22 16:32:31'),
(5, 49, 34, 'dd', 'stud', 'Propose', '2025-03-22 16:32:48'),
(6, 49, 34, 'dd', 'stud', 'Propose', '2025-03-22 16:34:41'),
(7, 49, 34, 'sdsd', 'stud', 'Propose', '2025-03-22 16:35:11'),
(8, 49, 34, 'sdsd', 'stud', 'Propose', '2025-03-22 16:35:13'),
(9, 49, 34, 'sdsd', 'stud', 'Propose', '2025-03-22 16:36:31'),
(10, 49, 34, 'f', 'stud', 'Propose', '2025-03-22 16:37:06'),
(11, 49, 34, 'fdf', 'prof', 'Propose', '2025-03-22 16:46:56'),
(12, 49, 34, 'df', 'prof', 'Propose', '2025-03-22 16:48:00'),
(13, 49, 34, '12333', 'prof', 'Propose', '2025-03-22 16:48:56'),
(14, 49, 34, 'dsd', 'stud', 'Propose', '2025-03-22 17:07:30'),
(15, 49, 34, 'sdfgh', 'stud', 'Propose', '2025-03-22 17:08:04'),
(16, 49, 34, 'dsdf', 'stud', 'Propose', '2025-03-22 17:11:18'),
(17, 49, 34, 'dsdf', 'stud', 'Applies', '2025-03-22 17:25:16'),
(18, 49, 34, 'Mesaj Applies Test', 'stud', 'Applies', '2025-03-22 17:25:38'),
(19, 49, 34, 'Mesaj Raspuns din Applies ', 'prof', 'Applies', '2025-03-22 17:31:49'),
(20, 49, 34, 'din Propose ', 'prof', 'Propose', '2025-03-22 17:33:27'),
(21, 49, 34, 'Mesaj test', 'stud', 'Propose', '2025-04-04 14:58:23');
...
--
-- Dumping data for table `profesorii_neverificati`
--

INSERT INTO `profesorii_neverificati` (`id`, `faculty`, `email`, `name`, `password`, `gmail_password`, `entered`, `cv_link`, `prof`) VALUES
(34, 'Facultatea de Matematică și Informatică', 'andreisv178@gmail.com', 'Andrei Sviridov', NULL, '62955712c92186bf9f976a8aeb69b1110ce8cb6c', 1, NULL, 1);
...
--
-- Dumping data for table `Propouses`
--

INSERT INTO `Propouses` (`id`, `title`, `study_program`, `faculty`, `prof_id`, `prof_name`, `stud_name`, `stud_email`, `description`, `motivation`, `state`, `date`, `stud_id`) VALUES
(94, 'Propunerea', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'sdps', 'kmsdk', 'accepted', '2025-03-22 15:25:52', 49),
(96, 'Propunerea ', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'Propunerea ', 'Propunerea ', 'accepted', '2025-03-22 15:28:25', 49),
(98, 'Propunerea ', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'Propunerea ', 'Propunerea ', 'accepted', '2025-03-22 15:28:39', 49),
(99, 'oskd,o', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'thesisinfo', 'thesisinfo', 'accepted', '2025-03-22 15:30:32', 49),
(105, 'Propunerea ', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'ds,lsdl', 'lc,sdc', 'confirmed', '2025-03-22 16:34:41', 49),
(106, 'SELECT * FROM `studentii` WHERE 1', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'SELECT * FROM `studentii` WHERE 1', 'SELECT * FROM `studentii` WHERE 1', 'waiting', '2025-03-22 17:29:02', 49),
(107, 'SELECT * FROM `studentii` WHERE 1SELECT * FROM `studentii` WHERE 1', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'SELECT * FROM `studentii` WHERE 1SELECT * FROM `studentii` WHERE 1', 'SELECT * FROM `studentii` WHERE 1', 'waiting', '2025-03-22 17:29:10', 49),
(108, 'Propunerea de licenta ', 'Informatica (forma de învățământ la distanță)', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', 'Descriere: În prezent temele de licență/disertație se centralizează folosind MS Office și Google Docs. În cadrul acestei teme studentul va dezvolta o aplicație web ce va permite încărcarea de teme de către cadrele didactice și selecția lor de către studenți urmând o procedură ce implică: trimiterea intenției de-a alege tema de către student și aprobarea de către cadrul didactic. Temele existente vor avea diferite stări: disponibilă, selectată. Autentificarea se va face prin contul de Google e-uvt.ro\nTehnologii: Tehnologii web client și server side.\nPoziții disponibile: 1', 'Descriere: În prezent temele de licență/disertație se centralizează folosind MS Office și Google Docs. În cadrul acestei teme studentul va dezvolta o aplicație web ce va permite încărcarea de teme de către cadrele didactice și selecția lor de către studenți urmând o procedură ce implică: trimiterea intenției de-a alege tema de către student și aprobarea de către cadrul didactic. Temele existente vor avea diferite stări: disponibilă, selectată. Autentificarea se va face prin contul de Google e-uvt.ro\nTehnologii: Tehnologii web client și server side.\nPoziții disponibile: 1', 'confirmed', '2025-04-04 17:58:56', 49);
...
(49, 'Facultatea de Matematică și Informatică', 'Informatica (forma de învățământ la distanță)', 'Andrei Sviridov', 'andrei.sviridov00@e-uvt.ro', '', 'cc8a4178b22f289bd88be4d8dede6ec385fa7d31', 0, 0, 3);
...
INSERT INTO `theses` (`id`, `title`, `faculty`, `prof_id`, `prof_name`, `description`, `requirements`, `start_date`, `end_date`, `state`, `cv_link`, `email`, `limita`, `isLetterRequired`) VALUES
(157, 'Title', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'lkmdsmdk', 'ksdmkds', '2025-02-28', '2025-03-22', 'open', NULL, 'andreisv178@gmail.com', 1, 0),
(158, 'dfl;sd', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'mls;df', 'l;sdm', '2025-03-01', '2025-03-02', 'open', NULL, 'andreisv178@gmail.com', 1, 1),
(159, ';dslfsdl', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', ';lslsd', ';lsd,l;', '2025-03-01', '2025-03-16', 'open', NULL, 'andreisv178@gmail.com', 1, 0),
(160, 's;dlsl', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', ';l,sld', 'l;sd,l', '2025-03-01', '2025-03-09', 'open', NULL, 'andreisv178@gmail.com', 1, 0),
(161, 'Nr 4 ', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'dfk', 'km', '2025-03-02', NULL, 'open', NULL, 'andreisv178@gmail.com', 1, 1),
(162, 'Titlu ', 'Facultatea de Matematică și Informatică', 34, 'Andrei Sviridov', 'Descriere: În prezent temele de licență/disertație se centralizează folosind MS Office și Google Docs. În cadrul acestei teme studentul va dezvolta o aplicație web ce va permite încărcarea de teme de către cadrele didactice și selecția lor de către studenți urmând o procedură ce implică: trimiterea intenției de-a alege tema de către student și aprobarea de către cadrul didactic. Temele existente vor avea diferite stări: disponibilă, selectată. Autentificarea se va face prin contul de Google e-uvt.ro\nTehnologii: Tehnologii web client și server side.\nPoziții disponibile: 1', 'Descriere: În prezent temele de licență/disertație se centralizează folosind MS Office și Google Docs. În cadrul acestei teme studentul va dezvolta o aplicație web ce va permite încărcarea de teme de către cadrele didactice și selecția lor de către studenți urmând o procedură ce implică: trimiterea intenției de-a alege tema de către student și aprobarea de către cadrul didactic. Temele existente vor avea diferite stări: disponibilă, selectată. Autentificarea se va face prin contul de Google e-uvt.ro\nTehnologii: Tehnologii web client și server side.\nPoziții disponibile: 1', '2025-04-02', '2025-04-20', 'open', NULL, 'andreisv178@gmail.com', 5, 1);
...
--
ALTER TABLE `favorite`
  MODIFY `favorite_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
